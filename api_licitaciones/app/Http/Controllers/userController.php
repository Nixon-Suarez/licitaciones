...
class userController extends Controller
{
    ...
    {   
        try{
            ...
            error_log("Error en registrarUsuarioControlador: " . $e->getMessage());
            http_response_code(500);
            echo json_encode([
                "code" => 500,
                "data" => 'Error al registrar el usuario, intente nuevamente'
    ...
    {   
        try{
            ...
            error_log("Error en actualizarUsuarioControlador: " . $e->getMessage());
            http_response_code(500);
            echo json_encode([
                "code" => 500,
                "data" => 'Error al actualizar el usuario, intente nuevamente'
            ]);
            return;
        }
    }
